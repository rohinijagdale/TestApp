...
class AJProgressView: UIView {
    ...
    public var imgLogo: UIImage = UIImage(named:"pb_back")!
    ...
    private func setupAJProgressView() {
        ...
        innerView.frame = CGRect(x: (ScreenSize.Width - widthProgressView)/2 + 15, y: (ScreenSize.Height - widthProgressView)/2 + 15, width: widthProgressView-40, height: widthProgressView-40)
